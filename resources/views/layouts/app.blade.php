                ...
                <div class="lg:col-span-1">
                    <div class="footer-section">
                        ...
                        <ul class="footer-links space-y-2">
                            ...
                            <li><a href="#" class="text-gray-300 hover:text-white transition-colors flex items-center"><i class="fas fa-chevron-right text-xs mr-2 text-yellow-400"></i> FAQ</a></li>
                            <li><a href="{{ route('admin.login') }}" class="text-gray-300 hover:text-white transition-colors flex items-center"><i class="fas fa-chevron-right text-xs mr-2 text-yellow-400"></i> Portal Admin</a></li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="footer-bottom mt-8 pt-6 border-t border-gray-800">
                <div class="copyright text-center text-gray-400 text-sm">
                    <p>
                        ...
                        | Developed by<i class="fas fa-heart text-red-500"></i> by Tim IT SMK N 2
                    </p>
                </div>
            </div>
        </div>
