        ...
        <div class="col-md-4">
            <div class="card">
                <div class="card-body text-center">
                    <img src="https://ui-avatars.com/api/?name={{ urlencode($admin->nama_lengkap) }}&background=D4AF37&color=2C001E&size=150" class="rounded-circle mb-3" alt="Profile Picture">
